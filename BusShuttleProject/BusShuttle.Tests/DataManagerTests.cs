...
public class DataManagerTests
{
    ...
    public DataManagerTests() {
        ...
        File.WriteAllText("drivers.txt", "Driver1"+Environment.NewLine+"Driver2"+Environment.NewLine+"Driver3"+Environment.NewLine);
    ...
    [Fact]
    public void Test_AddNewDriver()
    {
        Assert.Equal(3,dataManager.Drivers.Count);
        dataManager.AddNewDriver(new Driver("new driver"));
